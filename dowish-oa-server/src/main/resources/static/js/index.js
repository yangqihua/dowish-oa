    ...
    methods: {
        setMenuList: function (menuList) {
            menuList.forEach(function (menu) {
                if (menu.url != null && menu.url.indexOf("/sys") == 0) {
                    menu.url = "/modules" + menu.url + ".html";
                }
                if (menu.list != null) {
                    vm.setMenuList(menu.list)
                }
            })
        },
        getMenuList: function () {
            $.getJSON(baseURL + "sys/menu/user", function (r) {
                vm.setMenuList(r.menuList);
                vm.menuList = r.menuList;
                console.log("r.menuList", r.menuList);
        ...
        donate: function () {
            layer.open({
                ...
                closeBtn: 1,
                shadeClose: false,
                content: ['http://cdn.dowish.net/donate.jpg', 'no']
            });
        }
    },
    created: function () {
